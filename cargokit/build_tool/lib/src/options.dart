...
class CargokitCrateOptions {
  ...
  static CargokitCrateOptions load({
    ...
    print("[test] CargokitCrateOptions.load manifestDir:$manifestDir");
...
class CargokitUserOptions {
  ...
  static CargokitUserOptions load() {
    print("[test] CargokitUserOptions.load userProjectDir:${Environment.rootProjectDir}");
    ...
    while (userProjectDir.parent.path != userProjectDir.path) {
      ...
      print("[test] CargokitUserOptions.load configFile:$configFile");
